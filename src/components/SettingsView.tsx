              ...
              >
                ...
                <div className="flex items-center gap-1 shrink-0">
                  <button
                    ...
                    className="p-2 text-zinc-400 hover:text-white hover:bg-zinc-800 rounded-xl transition-colors opacity-0 group-hover:opacity-100"
            ...
            <div className="bg-[#121214] p-6 rounded-3xl border border-zinc-800 flex flex-col justify-between items-start gap-4">
              ...
              {!pushGranted && (
                <button
                  ...
                  className="mt-4 w-full py-2.5 bg-blue-500 hover:bg-blue-400 text-white text-sm font-medium rounded-xl transition-colors"
                >
                  Habilitar Push
                </button>
              )}
